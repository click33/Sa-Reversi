        ...
        <div>
            ...
            <el-form-item label="棋盘大小：" class="option-item right-to-left-3" style="margin-bottom: 50px;">
                <div class="xy-count-input-box right-to-left-5">
                    <el-input class="xy-count-input" v-model="selectStore.xCount" :disabled="props.mode === 'drawer' "
                              type="number" @blur="checkXCountYCount"></el-input>
                    <span class="xy-count-x"> x </span>
                    <el-input class="xy-count-input" v-model="selectStore.yCount" :disabled="props.mode === 'drawer' "
                              type="number" @blur="checkXCountYCount"></el-input>
                </div>
                <el-slider class="xy-count-slider right-to-left-6" v-model="selectStore.xyCount" :disabled="props.mode === 'drawer' "
...
.option-item{
    ...
    .chess-role-intro{ vertical-align: top; color: #888; margin-left: 20px; }
